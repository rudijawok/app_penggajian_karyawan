    ...
    return function t(e, s, i) {
                                            ...
                                            return p.parse = function(t) {
                                                ...
                                                p.startOf = function(t, h) {
                                                    var d = this,
                                                        ...
                                                        f = function(t, e) {
                                                            return w.w(d.toDate()[t].apply(d.toDate("s"), (
                                                                c ? [0, 0, 0, 0] : [23, 59, 59, 999]
                                                            ).slice(e)), d)
                                                        },
                                                        g = this.$W,
                                                        m = this.$M,
                                                ...
                                                p.$set = function(n, h) {
                                                    ...
                                                    if (c === r || c === o) {
                                                        ...
                                                        g.$d[p](f),
                                                            g.init(),
                                                            this.$d = g
                                                            .set(l, Math.min(this.$D, g.daysInMonth()))
                                                            .$d
                                                    } else
                                                        p && this.$d[p](f);
                                                    return this.init(),
                                    ...
                                    f = function(t, e, s) {
                                        try {
                                            ...
                                            var w = d || 0,
                                                ...
                                                M = f || 0;
                                            return g ?
                                                new Date(Date.UTC(y, v, b, w, C, x, M + 60 * g.offset * 1e3)) :
                                                s ?
        ...
        2: [
            function(t, e, s) {
                ...
                const i = t => "[object Object]" === Object
                    .prototype
                    .toString
                    .call(t),
                    a = (t, e) => {
                ...
                class l {
                        ...
                        t.forEach(((t, i) => {
                            ...
                            .forEach(((e, s) => {
                                i = e.cloneNode(!1),
                                    ...
                                    null !== e.searchIndex && void 0 !== e.searchIndex && (
                    ...
                    filter(t, e, s, i) {
                        ...
                        const n = a.filterState[t](),
                            r = Array
                            .from(a.filterState.originalData)
                            .filter((e => {
                                const s = e.cells[t],
                        ...
                        a.activeRows = [],
                            ...
                            .forEach(((r, h) => {
                                t = r.cloneNode(!1),
                                    ...
                                    null !== r.searchIndex && void 0 !== r.searchIndex && (
                ...
                class u {
                        ...
                        Object.assign(this.options, t || {}),
                            ...
                            setTimeout((() => {
                                this.emit("datatable.init"),
                                    this.initialized = !0,
                                    this.options.plugins && Object
                                    .entries(this.options.plugins)
                                    .forEach((([t, e]) => {
                                        this[t] && "function" == typeof this[t] && (
                    ...
                    render(t) {
                        ...
                        if (
                            ...
                            this.hasRows && (Array.from(this.body.rows[0].cells).forEach((() => {
                                ...
                                this
                                .table
                                .insertBefore(this.head, this.body),
                        ...
                        i.appendChild(n),
                            ...
                            this.container = this
                            .wrapper
                            .querySelector(".dataTable-container"),
                            this.pagers = this
                            .wrapper
                            .querySelectorAll(".dataTable-pagination-list"),
                            this.label = this
                            .wrapper
                            .querySelector(".dataTable-info"),
                            this
                            .table
                            .parentNode
                            .replaceChild(this.wrapper, this.table),
                            this
                            .container
                            ...
                            this.activeRows = this
                            .data
                            .slice(),
                            this.activeHeadings = this
                            .headings
                            .slice(),
                            this.update(),
                            this.setColumns(),
                    ...
                    renderPage() {
                        if (
                            this.hasHeadings && (n(this.header), this.activeHeadings.forEach((t => this.header.appendChild(t)))),
                            ...
                            this
                                .pages[t]
                                .forEach((t => e.appendChild(this.rows().render(t)))),
                                this.clear(e),
                    ...
                    renderPager() {
                        if (n(this.pagers), this.totalPages > 1) {
                            ...
                            this.options.truncatePager && (n = ((t, e, s, i, n) => {
                                ...
                                this.options.firstLast && e.appendChild(
                                    r(t, this.totalPages, this.options.lastText)
                                ),
                                this
                                .pagers
                                .forEach((t => {
                    ...
                    renderHeader() {
                        this.labels = [],
                            this.headings && this.headings.length && this
                            .headings
                            .forEach(((t, e) => {
                                if (
                            ...
                            .addEventListener("click", (e => {
                                ...
                                s && "a" === s
                                    ...
                                    .toLowerCase() && (
                                        ...
                                        t.sortable && s.classList.contains("dataTable-sorter") && "false" != s.parentNode.getAttribute(
                                            "data-sortable"
                                        ) && (
                    ...
                    setColumns(t) {
                        t || this
                            ...
                            this.options.columns && this.headings.length && this
                            .options
                            .columns
                            .forEach((t => {
                                Array.isArray(t.select) || (t.select = [t.select]),
                                    t.hasOwnProperty("render") && "function" == typeof t.render && (
                                    ...
                                    .forEach((e => {
                                        ...
                                        t.type && s.setAttribute("data-type", t.type),
                                            ...
                                            t.hasOwnProperty("hidden") && !1 !== t.hidden && this
                                            .columns()
                                            .hide([e]),
                                            t.hasOwnProperty("sort") && 1 === t.select.length && this
                                            .columns()
                                            .sort(t.select[0], t.sort, !0)
                                    }))
                            })),
                            this.hasRows && (
                                        ...
                                        .forEach(((e, s) => {
                                            this
                                                ...
                                                .forEach((i => {
                                                    i
                                                        .columns
                                                        .includes(s) && (e.innerHTML = i.renderer.call(this, e.data, e, t))
                                                }))
                                        }))
                                })),
                    ...
                    destroy() {
                        this.table.innerHTML = this.initialLayout,
                            ...
                            .wrapper
                            .parentNode
                            .replaceChild(this.table, this.wrapper),
                            this.initialized = !1,
                    ...
                    fixColumns() {
                        if ((this.options.scrollY.length || this.options.fixedColumns) && this.activeHeadings && this.activeHeadings.length) {
                            ...
                            if (this.columnWidths = [], this.table.tHead) {
                                ...
                                const s = a("tr");
                                Array
                                    .from(this.table.tBodies[0].rows[0].cells)
                                    .forEach((() => {
                                        const e = a("th");
                                        s.appendChild(e),
                                            t.push(e)
                    ...
                    page(t) {
                        return t != this.currentPage && (
                            isNaN(t) || (this.currentPage = parseInt(t, 10)), !(t > this.pages.length || t < 0) && (this.render("page"), this.render("pager"), void this.emit("datatable.page", t))
                        )
                    }
                    sortColumn(t, e) {
                        this
                    ...
                    clear(t) {
                        ...
                        this.body || (e = this.table),
                            t && (
                                "string" == typeof t && (document.createDocumentFragment().innerHTML = t),
                                e.appendChild(t)
                            )
                    }
                    export (t) {
                            ...
                            if (s.length) {
                                if ("txt" === l.type || "csv" === l.type) {
                                    ...
                                    for (h = `INSERT INTO \`${l.tableName}\` (`, n = 0; n < e.length; n++)
                                        !l
                                        .skipColumn
                                        .includes(e[n].originalCellIndex) && this
                                        .columns(e[n].originalCellIndex)
                                        .visible() && (h += `\`${e[n].textContent}\`,`);
                                    for (
                                        ...
                                        for (h += "(", r = 0; r < s[n].cells.length; r++)
                                            !l
                                            .skipColumn
                                            .includes(e[r].originalCellIndex) && this
                                            .columns(e[r].originalCellIndex)
                                            .visible() && (h += `"${s[n].cells[r].textContent}",`);
                                        h = h
                                            .trim()
                                            .substring(0, h.length - 1),
                                            h += "),"
                                    ...
                                    for (r = 0; r < s.length; r++)
                                        for (a[r] = a[r] || {}, n = 0; n < e.length; n++)
                                            ...
                                            .includes(e[n].originalCellIndex) && this
                                            .columns(e[n].originalCellIndex)
                                            .visible() && (a[r][e[n].textContent] = s[r].cells[n].textContent);
                    ...
                    setMessage(t) {
                        ...
                        this.hasRows ?
                            ...
                            this.render("pager"),
                            this.clear(
                                a("tr", { html: `<td class="dataTables-empty" colspan="${e}">${t}</td>` })
                            )
                    }
                    columns(t) {
                        return new l(this, t)
                    ...
                    off(t, e) {
                        this.events = this.events || {},
                            t in this.events != 0 && this
                            .events[t]
                            .splice(this.events[t].indexOf(e), 1)
                    }
                    emit(t) {
